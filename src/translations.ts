  ...
  ru: {
    ...
    testimonials: {
      ...
      items: [
        ...
        {
          author: { name: 'Эрмек Б.', handle: '@ermek_logistic', avatar: 'https://images.unsplash.com/photo-1541701494587-cb58502866ab?w=150&h=150&fit=crop' },
          text: 'Сайт отрабатывает на 10/10. Быстрая загрузка, удобная админка. Конверсия выросла в полтора раза.',
        },
        {
          author: { name: 'Гульмира Т.', handle: '@gul_beauty', avatar: 'https://images.unsplash.com/photo-1557672172-298e090bd0f1?w=150&h=150&fit=crop' },
          text: 'Идеальное попадание в стиль бренда. Картинка сочная, а запуск занял всего 10 дней.',
        },
        {
          author: { name: 'Данияр О.', handle: '@dan_dev', avatar: 'https://images.unsplash.com/photo-1518640467707-6811f4a6ab73?w=150&h=150&fit=crop' },
  ...
  uz: {
    ...
    testimonials: {
      ...
      items: [
        ...
        {
          author: { name: 'Ermek B.', handle: '@ermek_logistic', avatar: 'https://images.unsplash.com/photo-1541701494587-cb58502866ab?w=150&h=150&fit=crop' },
          text: 'The site works 10/10. Fast loading, convenient admin panel. Conversion grew 1.5 times.',
        },
        {
          author: { name: 'Gulmira T.', handle: '@gul_beauty', avatar: 'https://images.unsplash.com/photo-1557672172-298e090bd0f1?w=150&h=150&fit=crop' },
          text: 'Perfect brand matching. The image is juicy, and the launch took only 10 days.',
        },
        {
          author: { name: 'Daniyar O.', handle: '@dan_dev', avatar: 'https://images.unsplash.com/photo-1518640467707-6811f4a6ab73?w=150&h=150&fit=crop' },
          text: 'As a techie, I appreciated the code quality. No lags, 90+ in Google PageSpeed. Highly recommend.',
        },
      ],
    },
    faq: {
  ...
  kg: {
    ...
    testimonials: {
      ...
      items: [
        ...
        {
          author: { name: 'Эрмек Б.', handle: '@ermek_logistic', avatar: 'https://images.unsplash.com/photo-1541701494587-cb58502866ab?w=150&h=150&fit=crop' },
          text: 'Сайт 10/10 иштейт. Тез жүктөө, ыңгайлуу админка. Конверсия бир жарым эсе өстү.',
        },
        {
          author: { name: 'Гүлмира Т.', handle: '@gul_beauty', avatar: 'https://images.unsplash.com/photo-1557672172-298e090bd0f1?w=150&h=150&fit=crop' },
          text: 'Бренддин стилине идеалдуу дал келди. Дизайн сонун, ал эми ишке киргизүү 10 гана күндү алды.',
        },
        {
          author: { name: 'Данияр О.', handle: '@dan_dev', avatar: 'https://images.unsplash.com/photo-1518640467707-6811f4a6ab73?w=150&h=150&fit=crop' },
          text: 'IT адиси катары мен коддун сапатын бааладым. Эч кандай лаг жок, Google PageSpeed 90+. Сунуштайм.',
        },
      ],
    },
    faq: {
